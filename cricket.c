...
void batting(){
    if(!strncmp(first_bat,select_team)){
        battingchoice=1;
    }else{
        battingchoice=2;
    }
        ...
        if(battingchoice==1){
            ...
            while(ball<30){
                ...
                if(!strcmp(marks[num],"wide")){
                    ...
                    if(ball%6==0){
                        ...
                        printf("\xdb\t%s\t%d/%d\t\xdb\n",select_team,total,wicket);
            ...
            while(ball<30){
                ...
                if(!strcmp(marks[num],"0")){
                    ...
                    cteam2[current_player].balls+=1;

                    cteam1[baller].b_balls+=1;
                }
                if(!strcmp(marks[num],"1")){
                    total2+=1;
                    cteam2[current_player].runs+=1;
                    cteam2[current_player].balls+=1;
                    if(current_player==no1){
                        current_player=no2;
                    }else{
                    ...
                    cteam1[baller].b_runs+=1;
                    cteam1[baller].b_balls+=1;
                }
                if(!strcmp(marks[num],"2")){
                    total2+=2;
                    cteam2[current_player].runs+=2;
                    cteam2[current_player].balls+=1;

                    cteam1[baller].b_runs+=2;
                    cteam1[baller].b_balls+=1;
                }
                if(!strcmp(marks[num],"3")){
                    total2+=3;
                    cteam2[current_player].runs+=3;
                    cteam2[current_player].balls+=1;
                    if(current_player==no1){
                        current_player=no2;
                    }else{
                    ...
                    cteam1[baller].b_runs+=3;
                    cteam1[baller].b_balls+=1;
                }
                if(!strcmp(marks[num],"4")){
                    total2+=4;
                    cteam2[current_player].runs+=4;
                    cteam2[current_player].balls+=1;

                    cteam1[baller].b_runs+=4;
                    cteam1[baller].b_balls+=1;
                }
                if(!strcmp(marks[num],"6")){
                    total2+=6;
                    cteam2[current_player].runs+=6;
                    cteam2[current_player].balls+=1;

                    cteam1[baller].b_runs+=6;
                    cteam1[baller].b_balls+=1;
                }
                if(!strcmp(marks[num],"w")){
                    wicket+=1;
                ...
                if(!strcmp(marks[num],"wide")){
                    ...
                    if(ball%6==0){
                        overs++;
                        cteam1[baller].b_overs+=1;
                        printf("\n\n%s\t%d\t%d\n",cteam2[no1].pname,cteam2[no1].runs,cteam2[no1].balls);
                        printf("%s\t%d\t%d\n",cteam2[no2].pname,cteam2[no2].runs,cteam2[no2].balls);
                        printf("\n%s\t%d\t%d\t%d\n",cteam1[baller].pname,cteam1[baller].b_overs,cteam1[baller].b_runs,cteam1[baller].b_wickets);
                        printf("\n\n\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\n");
                        printf("\xdb\t%s\t%d/%d\t\xdb\n",unselsect_team,total2,wicket);
                        printf("\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\n");
                        baller++;
                        if(overs<5){
            ...
            printf("\n\n%Total\t:%d\nWickets\t:%d\nOvers\t:%d\n\n",total2,wicket,overs);
            for(int z=0;z<=wicket+1;z++){
                printf("%s\t\t%d\t%d\n",cteam2[z].pname,cteam2[z].runs,cteam2[z].balls);
            }
            battingtimes++;
            battingchoice=1;
            first_bat_total=total2;
        }
    }
